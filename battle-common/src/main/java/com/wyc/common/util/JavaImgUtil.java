...
public class JavaImgUtil{
	public static void main(String[]args)throws Exception{
		...
		Pic tt = new JavaImgUtil.Pic();  
		  
        BufferedImage d = tt.loadImageUrl("http://7xlw44.com1.z0.glb.clouddn.com/0042aeda-d8a5-4222-b79d-1416ab222898");
        
        BufferedImage b = tt.loadImageUrl("http://ovqk5bop3.bkt.clouddn.com/qrcode.jpeg");
